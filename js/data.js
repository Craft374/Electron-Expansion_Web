...
var SYNTH = {
  reqResearched: 1,   // 수소 연구 후 탭 해금
  base: "1e3",        // 원소당 기본 비용(원자번호 1 기준). 무거운 원소일수록 자동으로 소량.
  grow: 2.2,          // 레벨당 비용 ×
  effect: 1.4         // 레벨당 구성 원소 생산 ×1.4
};
// e: 구성 원소 번호(=강화 대상). f: 화학식, n: 이름.
var COMPOUNDS = [
  { id: "h2o",   f: "H₂O",   n: "물",          e: [1, 8] },
  { id: "ch4",   f: "CH₄",   n: "메탄",        e: [6, 1] },
  { id: "co",    f: "CO",    n: "일산화탄소",  e: [6, 8] },
  { id: "co2",   f: "CO₂",   n: "이산화탄소",  e: [6, 8] },
  { id: "lih",   f: "LiH",   n: "수소화 리튬", e: [3, 1] },
  { id: "nh3",   f: "NH₃",   n: "암모니아",    e: [7, 1] },
  { id: "hf",    f: "HF",    n: "플루오린화수소", e: [1, 9] },
  { id: "beo",   f: "BeO",   n: "산화 베릴륨", e: [4, 8] },
  { id: "b2o3",  f: "B₂O₃",  n: "산화 붕소",   e: [5, 8] },
  { id: "bn",    f: "BN",    n: "질화 붕소",   e: [5, 7] },
  { id: "no2",   f: "NO₂",   n: "이산화질소",  e: [7, 8] },
  { id: "o3",    f: "O₃",    n: "오존",        e: [8] },
  { id: "nacl",  f: "NaCl",  n: "소금",        e: [11, 17] },
  { id: "naoh",  f: "NaOH",  n: "수산화나트륨", e: [11, 8, 1] },
  { id: "na2co3",f: "Na₂CO₃",n: "탄산나트륨",  e: [11, 6, 8] },
  { id: "mgo",   f: "MgO",   n: "산화 마그네슘", e: [12, 8] },
  { id: "mgcl2", f: "MgCl₂", n: "염화 마그네슘", e: [12, 17] },
  { id: "caf2",  f: "CaF₂",  n: "형석",        e: [20, 9] },
  { id: "glucose",f:"C₆H₁₂O₆",n:"글루코스",    e: [6, 1, 8] },
  { id: "al2o3", f: "Al₂O₃", n: "알루미나",    e: [13, 8] },
  { id: "al2so4",f: "Al₂(SO₄)₃", n: "황산 알루미늄", e: [13, 16, 8] },
  { id: "sio2",  f: "SiO₂",  n: "석영",        e: [14, 8] },
  { id: "sic",   f: "SiC",   n: "탄화 규소",   e: [14, 6] },
  { id: "ph3",   f: "PH₃",   n: "포스핀",      e: [15, 1] },
  { id: "p4o10", f: "P₄O₁₀", n: "오산화 인",   e: [15, 8] },
  { id: "h2so4", f: "H₂SO₄", n: "황산",        e: [1, 16, 8] },
  { id: "so2",   f: "SO₂",   n: "이산화황",    e: [16, 8] },
  { id: "hcl",   f: "HCl",   n: "염산",        e: [1, 17] },
  { id: "kcl",   f: "KCl",   n: "염화 칼륨",   e: [19, 17] },
  { id: "koh",   f: "KOH",   n: "수산화 칼륨", e: [19, 8, 1] },
  { id: "kno3",  f: "KNO₃",  n: "초석",        e: [19, 7, 8] },
  { id: "cao",   f: "CaO",   n: "생석회",      e: [20, 8] },
  { id: "caco3", f: "CaCO₃", n: "석회석",      e: [20, 6, 8] },
  { id: "caso4", f: "CaSO₄", n: "석고",        e: [20, 16, 8] },
  { id: "tio2",  f: "TiO₂",  n: "이산화 티타늄", e: [22, 8] },
  { id: "cr2o3", f: "Cr₂O₃", n: "산화 크로뮴", e: [24, 8] },
  { id: "vo2",   f: "VO₂",   n: "산화 바나듐", e: [23, 8] },
  { id: "mno2",  f: "MnO₂",  n: "이산화 망가니즈", e: [25, 8] },
  { id: "fes",   f: "FeS",   n: "황철석",      e: [26, 16] },
  { id: "fe3c",  f: "Fe₃C",  n: "시멘타이트",  e: [26, 6] },
  { id: "steel", f: "Fe·Cr", n: "스테인리스",  e: [26, 24] },
  { id: "toolsteel", f: "Fe·V·Cr·Mn", n: "공구강", e: [26, 23, 24, 25] },
  { id: "harf",  f: "HArF",  n: "아르곤 불화수소", e: [18, 1, 9] },
  { id: "heclath",f:"He·H₂O",n: "헬륨 클라스레이트", e: [2, 1, 8] },
  { id: "neexc", f: "Ne*",   n: "네온 엑시머", e: [10] }
];
